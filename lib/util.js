...
module.exports = {
  ...
  // Utility function to check if an object has a given property
  ...
  // Device groups for specific functionalities
  ...
  // Device classifications by functionality
  ...
  // Parameters to retain from device messages
  paramsToKeep: [
    "battery",
    "bright",
    "brightness",
  ...
  // Default settings for various multi-switch devices
  ...
  // Default settings for various device types
  defaultCurtainCache: { cacheCurrentPosition: 0 },
  defaultBlindCache: {
  ...
  // Mapping channels from device UIID
  chansFromUiid: {
